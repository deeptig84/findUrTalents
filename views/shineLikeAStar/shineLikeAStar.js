...
var shineLikeAStarForm = forms.create({
...
function renderForm(req,res,locals){
  res.render('shineLikeAStar/shineLikeAStar', extend({
    title: 'My shineLikeAStar',
...
module.exports = function shineLikeAStar(){
